    ...
    return (
        <div className="min-h-screen bg-white selection:bg-wispr-purple selection:text-white flex flex-col">
            ...
            <main className="flex-grow">
                ...
                {/* Content Sections */}
                <section className="py-20 md:py-40 px-6 bg-black relative overflow-hidden border-t border-white/5">
                    <div className="absolute inset-0 grid-bg-dark opacity-[0.08]"></div>
                    <div className="max-w-4xl mx-auto relative z-10">
                        <div className="space-y-16 md:space-y-32">
                            {service.sections.map((section, idx) => (
                                <div key={idx} className="reveal-advanced" style={{ transitionDelay: `${idx * 150}ms` }}>
                                    <div className="inline-flex items-center space-x-3 px-4 py-1.5 rounded-full bg-wispr-purple/10 border border-wispr-purple/20 mb-8 backdrop-blur-md">
                ...
                {/* FAQs Section */}
                <div className="bg-black py-10 md:py-20 px-6 border-t border-white/5">
